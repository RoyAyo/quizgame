...
function createradios(q){
	...
	$('<input type="radio" onclick="setter(2,\'check\') name="quest" id="opt1" class="btnQ" value="'+mydata.result[q].option1+'" >').appendTo("#op"+p[0]);
	$('<label for="opt1" class="btnQ"><span>'+ mydata.result[q].option1 + '</span></label>').insertAfter("#opt1");
	$('<input type="radio" onclick="setter(2,\'check\') name="quest" id="opt2" class="btnQ" value="'+mydata.result[q].option2+'">').appendTo("#op"+p[1]);
	$('<label for="opt2" class="btnQ"><span>'+ mydata.result[q].option2 + '</span></label>').insertAfter("#opt2");
	$('<input type="radio" onclick="setter(2,\'check\') name="quest" id="opt3" class="btnQ" value="'+mydata.result[q].option3+'">').appendTo("#op"+p[2]);
	$('<label for="opt3" class="btnQ"><span>'+ mydata.result[q].option3 + '</span></label>').insertAfter("#opt3");
	$('<input type="radio" onclick="setter(2,\'check\') name="quest" id="opt4" class="btnQ" value="'+mydata.result[q].answer+'">').appendTo("#op"+p[03]);
	$('<label for="opt4" class="btnQ"><span>'+ mydata.result[q].answer + '</span></label>').insertAfter("#opt4");
	$('<div class="button-space"><span><button type="button" class="check animated bounceInLeft" onclick="setter(2,\'check\')">None</button></span><span><button type="button" class="skip animated bounceInLeft" onclick="setter(2,\'skip\')">Skip</button><span></div>').appendTo("#div2");
